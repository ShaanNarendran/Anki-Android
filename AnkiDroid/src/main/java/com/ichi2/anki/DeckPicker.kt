...
open class DeckPicker :
     ...
     * Hides the navigation drawer and shows the bottom nav with tab switching.
     */
        ...
        bottomNav.setOnItemSelectedListener { item ->
            when (item.itemId) {
                R.id.nav_home -> {
                    ...
                    binding.toolbarContainer.isVisible = true
                    deckPickerBinding.deckpickerView.isVisible = true
                    floatingActionMenu.showFloatingActionButton()
                    true
                }
                R.id.nav_browser -> {
                    showBottomNavFragment(CardBrowserFragment(), "browser")
                    true
                }
                R.id.nav_stats -> {
                    showBottomNavFragment(Statistics(), "stats")
                    true
                }
                R.id.nav_more -> {
                    showBottomNavFragment(MoreFragment(), "more")
                    true
                }
                else -> false
            }
    ...
    private fun showBottomNavFragment(
        ...
        deckPickerBinding.deckpickerView.isVisible = false
        floatingActionMenu.hideFloatingActionButton()
        val container = findViewById<View>(R.id.bottom_nav_fragment_container)
